...
[![Build Status](https://travis-ci.org/messagebird/go-rest-api.svg?branch=master)](https://travis-ci.org/messagebird/go-rest-api) [![PkgGoDev](https://pkg.go.dev/badge/github.com/Bijles-aan-Huis-B-V/messagebird-go-rest-api)](https://pkg.go.dev/github.com/Bijles-aan-Huis-B-V/messagebird-go-rest-api)
